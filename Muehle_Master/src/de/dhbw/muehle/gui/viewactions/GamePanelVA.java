...
public class GamePanelVA {
	...
	public class lblGameStoneMouse implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			...
			/**
			 * Hier wird überprüft in welcher Spielphase sich das Spiel befindet
			 * Spielphase 1 == Steine setzten Spielphase 2 == Steine ziehen
			 * Spielphase 3 == Springen
			 */

			// Hier wird überprüft ob das Spiel in der Steine setzen Phase (1)
			// ist
			if (vController.getCore().getSpielphase() == 1) {
				...
				// Hier wird überprüft ob das Spiel in der Steine ziehen Phase
				// (2) ist
